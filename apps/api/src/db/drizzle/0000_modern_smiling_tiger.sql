...
ALTER TABLE `messages` ADD CONSTRAINT `messages_thread_id_threads_id_fk` FOREIGN KEY (`thread_id`) REFERENCES `threads`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
